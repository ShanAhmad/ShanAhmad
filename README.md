...
Xspace CRM – Alibaba Internal CRM (Java, Spring Boot, Redis, Alibaba Cloud)

Seller Claims Center – Built from scratch for Daraz Seller Platform

Alime Chatbot (Xiaomi) – Feature development & production deployment

Novus Xcite – Loan Management System with REST-based modernization
...
Alibaba Cloud (Multiple Certifications):
